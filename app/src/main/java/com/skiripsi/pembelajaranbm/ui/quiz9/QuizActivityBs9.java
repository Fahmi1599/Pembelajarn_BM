...
public class QuizActivityBs9 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_bs_sembilan);
        ...
        QuizDBHelperBS9 dbHelper = new QuizDBHelperBS9(this);
