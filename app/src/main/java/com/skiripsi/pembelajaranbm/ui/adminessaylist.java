...
public class adminessaylist extends AppCompatActivity {
    ...
    userEssayQuizAdapter userQuizAdapter;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_essay_admin_list);
        ...
        userQuizAdapter = new userEssayQuizAdapter(this,userList);
